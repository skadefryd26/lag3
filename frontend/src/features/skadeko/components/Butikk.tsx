...
export const VARER: Vare[] = [
  ...
  {
    id: 'blaerekapasitet',
    navn: 'Ekstra blærekapasitet',
    navnEn: 'Extra bladder capacity',
    emoji: '🚽',
    beskrivelse: 'Blæren fylles 50 % saktere neste arbeidsdag.',
    beskrivelseEn: 'Your bladder fills 50 % slower the next working day.',
    pris: 200,
  },
  {
    id: 'stressball',
